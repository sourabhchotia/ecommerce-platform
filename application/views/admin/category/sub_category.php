                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="categoryName" class="control-label col-form-label">Sub Category Name</label>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select col-12 categorySelect" id="parentCat" name="parentCategory">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($mainCategories){ foreach($mainCategories as $category){ 
