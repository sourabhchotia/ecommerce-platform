                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <form class="" id="categoryForm" enctype="multipart/form-data">
                                <div class="card-body">
                                    <h4 class="card-title">Add Inner Category</h4>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="categoryName" class="control-label col-form-label">Inner Category Name</label>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($subCategories){ foreach($subCategories as $category){ 
