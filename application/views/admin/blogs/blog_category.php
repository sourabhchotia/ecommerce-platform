            ...
            <div class="container-fluid">
                ...
                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="categoryName" class="control-label col-form-label">Category Name</label>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Parent Category Listing</h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="<?= site_url() ?>uploads/blogs/category/thumbs/<?= $filename ?>-50x50.<?= $file_ext ?>" alt="iMac">
                                                </td>
                                                <td><?= $category->category_name ?></td>
                                                <td><?php if($admins){ foreach($admins as $admin){ 
                                                            if($admin->admin_id == $category->category_created_by){
                                                ...
                                                <td>
                                                    <a href="javascript:void(0)" class="text-inverse p-r-10 edit" data-toggle="tooltip" title="" data-original-title="Edit" data-id="<?= $category->category_id ?>"><i class="ti-marker-alt"></i></a>
                                                    <?php if($category->category_status == 1){ ?>
                                                        <a href="javascript:void(0)" class="text-inverse p-r-10 disable" data-toggle="tooltip" title="" data-original-title="Disable" data-id="<?= $category->category_id ?>"  data-status="0"><i class="ti-trash"></i></a>
                                                    <?php }else{ ?>
                                                        <a href="javascript:void(0)" class="text-inverse p-r-10 disable" data-toggle="tooltip" title="" data-original-title="Disable" data-id="<?= $category->category_id ?>"  data-status="1"><i class="ti-check-box"></i></a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                            <?php } } ?>
