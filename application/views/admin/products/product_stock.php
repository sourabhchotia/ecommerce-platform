                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <form action="" method="post">
                                            ...
                                            <div class="form-group col-3">
                                                <button type="button" name="customSearchStock" id="customSearchStock" class="btn btn-success m-r-10">Search</button>
                                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table product-overview" id="stockTable">
                                        <thead>
                                            <tr>
                                                <th>Image</th>
                                                <th>SKU</th>
